...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#5b4bd6" },
      { title: "Attendify — Smart Class Attendance" },
      { name: "description", content: "Modern QR-based attendance for students and lecturers." },
      { property: "og:title", content: "Attendify — Smart Class Attendance" },
      { property: "og:description", content: "Mark attendance in seconds with QR scanning, real-time tracking and analytics." },
